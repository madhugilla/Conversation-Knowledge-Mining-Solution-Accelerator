...
public class CreateCuTemplateText
{
    ...
    private const string AnalyzerTemplateFile = "ckm-analyzer_config_text.json";

    private readonly ILogger<CreateCuTemplateText> _logger;
    private readonly DefaultAzureCredential _credential;

    public CreateCuTemplateText(ILogger<CreateCuTemplateText> logger)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Creating Content Understanding analyzer for text...");
        ...
        _logger.LogInformation("Text analyzer created successfully.");
        result.Dispose();
    }
}